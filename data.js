...
window.portfolioData = {
  ...
  /* nota 2026-07-12: 8 compras nuevas registradas (Lee Sin Ascetic 18E, Jinx Loose Cannon Origins Promos 32E,
     Leona Radiant Dawn 13E, Jinx Rebel V.1 Epic 43E, Viktor Leader V.1 Epic 32E, Lux Lady of Luminosity 15E,
     Jinx Loose Cannon V.2 Showcase 72E, Miss Fortune Bounty Hunter V.2 Showcase 80E). Rarity ampliada en Notion
     con Showcase/Overnumbered/Signed Showcase/Plated (antes se mapeaba todo a "Promo"). Corregido naming de
     Viktor Leader y Yasuo Unforgiven para coincidir exactamente con el h1 de Cardmarket. Full price check de
     las 47 posiciones en Holding (precio excluye listados propios de Nacho/Narsonius en Cardmarket, ej. Mystic Poro). */
